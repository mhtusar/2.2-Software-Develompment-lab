...
public class LatteActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView.setImageResource(R.drawable.clatte);
    ...
    private boolean SaveCart() {
        ...
        if (addExtraCream.isChecked()) {
            values.put(OrderContract.OrderEntry.COLUMN_CREAM, " YES");
        } else {
            values.put(OrderContract.OrderEntry.COLUMN_CREAM, " NO");

        }

        if (addToppings.isChecked()) {
            values.put(OrderContract.OrderEntry.COLUMN_HASTOPPING, " YES");
        } else {
            values.put(OrderContract.OrderEntry.COLUMN_HASTOPPING, " NO");
