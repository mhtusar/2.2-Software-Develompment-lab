...
public class OrderAdapter extends RecyclerView.Adapter<OrderAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (position == 2) {
                Intent intent2 = new Intent(context, AmericanoActivity.class);
                context.startActivity(intent2);
            }
            if (position == 3) {
                Intent intent3 = new Intent(context, OrangeVanillaActivity.class);
                context.startActivity(intent3);
            }
            if (position == 4) {
                Intent intent4 = new Intent(context, CappucinoActivity.class);
                context.startActivity(intent4);
            }
            if (position == 5) {
                Intent intent5 = new Intent(context, ThaiteaActivity.class);
                context.startActivity(intent5);
            }
            if (position == 6) {
                Intent intent6 = new Intent(context, TeaActivity.class);
                context.startActivity(intent6);
            }
            if (position == 7) {
                Intent intent7 = new Intent(context, BubbleActivity.class);
                context.startActivity(intent7);
            }
            if (position == 8) {
                Intent intent8 = new Intent(context, MatchaActivity.class);
